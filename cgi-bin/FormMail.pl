...
BEGIN
{
  ...
  @referers          = qw(lovelandcanoe.com kayakcincinnati.com 8.17.86.55  localhost);
  @allow_mail_to     = qw(mbersani@cinci.rr.com rbersani@cinci.rr.com
                          5132954739@vtext.com 5132905958@messaging.sprintpcs.com
                          cbiedenharn@fuse.net rob@agileconsultingllc.com localhost);
  @recipients        = ();
...
From: reservation@kayakcincinnati.com (Online Reservation)
Subject: Kayak Cincinnati Reservation
